...
[![Testler](https://img.shields.io/badge/testler-3159%20ye%C5%9Fil-brightgreen.svg)](app/tests/)
...
> 3.159 yeşil test · 14/14 ağsız kanıt adımı · yayımlanmış altın veri seti
...
| Test | **3.212** toplanan · 3.159 geçti · 53 atlandı (Postgres, CI'da koşar) · 0 başarısız | `python -m scripts.test_ozeti` — ölçüm 2026-08-19 |
...
# Tüm test paketi — 19 Ağu ölçümü: 3.212 toplandı, 3.159 geçti, 53 atlandı, 0 başarısız.
...
│   ├── tests/                   #   3.159 birim/entegrasyon testi (offline)
