...
[![Testler](https://img.shields.io/badge/testler-3142%20ye%C5%9Fil-brightgreen.svg)](app/tests/)
...
> 3.142 yeşil test · 14/14 ağsız kanıt adımı · yayımlanmış altın veri seti
...
| Test | **3.195** toplanan · 3.142 geçti · 53 atlandı (Postgres, CI'da koşar) · 0 başarısız | `python -m scripts.test_ozeti` — ölçüm 2026-08-19 |
...
# Tüm test paketi — 19 Ağu ölçümü: 3.195 toplandı, 3.142 geçti, 53 atlandı, 0 başarısız.
...
│   ├── tests/                   #   3.142 birim/entegrasyon testi (offline)
