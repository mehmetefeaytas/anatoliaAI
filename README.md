...
[![Testler](https://img.shields.io/badge/testler-3150%20ye%C5%9Fil-brightgreen.svg)](app/tests/)
...
> 3.150 yeşil test · 14/14 ağsız kanıt adımı · yayımlanmış altın veri seti
...
| Test | **3.203** toplanan · 3.150 geçti · 53 atlandı (Postgres, CI'da koşar) · 0 başarısız | `python -m scripts.test_ozeti` — ölçüm 2026-08-19 |
...
# Tüm test paketi — 19 Ağu ölçümü: 3.203 toplandı, 3.150 geçti, 53 atlandı, 0 başarısız.
...
│   ├── tests/                   #   3.150 birim/entegrasyon testi (offline)
