...
[![Testler](https://img.shields.io/badge/testler-3579%20ye%C5%9Fil-brightgreen.svg)](app/tests/)
...
> 2.708 gerçek belge · 10/10 katılım bankası · 999 PDF · 3.579 yeşil test ·
...
| Test | **3.632** toplanan · 3.579 geçti · 53 atlandı (Postgres, CI'da koşar) · 0 başarısız · 1.727 alt-test | `python -m unittest discover -s tests` — ölçüm 2026-08-23 |
...
# Tüm test paketi — 23 Ağu ölçümü: 3.632 toplandı, 3.579 geçti, 53 atlandı, 0 başarısız.
...
│   ├── tests/                   #   3.579 birim/entegrasyon testi (offline)
