...
- Çıktı: `data/gold/gold.round1.recall.json`
- SHA-256: `a27d4ac1fe8183f6de77ec13041d604c937317bdca18373d6792cd82f8cc87bf`
- Kayıt: **134**
- Çift anote edilmiş kayıt: **46**
- 12/12 alan karara bağlı (recall ÖLÇÜLEBİLİR): **5**
- Kampanya sayılmayıp elenen belge: **10**
- Çelişki (anotatörler ayrıştı): **11**
- Hakemlik bekleyen kayıt: **13**
- Hakemlikten/şema onarımından geçmiş kayıt (`adjudicated`): **38** — damgalar: `#hakemlik-round1`, `#sema-onarimi-round1`
- Kanıtlı alan (`field_spans`): **133/157** (%84.7)
...
| `data/gold/review/round1_recall_opus.csv` | **v2** | karar verilmedi — gold'a GİRMEZ |
...
- **Recall:** yalnızca 12/12 kapsanan 5 kayıtta ölçülebilir; diğerlerinde anote edilmemiş alan ile gerçekten olmayan alan ayrılamaz.

## Kanıt (`field_spans`)

- Kanıtlı: **133/157** alan
- Kanıtsız: **24** alan — değer var, belgede birebir geçen alıntısı yok.
...
|---|---:|---:|---:|---:|
| `kar_payi_orani` | 8 | 7 | 13 | 0 |
| `finansman_tutari` | 22 | 15 | 7 | 3 |
| `vade_ay` | 33 | 27 | 32 | 4 |
| `taksit_sayisi` | 16 | 16 | 7 | 0 |
| `tahsis_ucreti` | 0 | 0 | 10 | 0 |
| `masraf_durumu` | 7 | 4 | 7 | 0 |
| `odul_miktari` | 4 | 3 | 12 | 1 |
| `indirim_orani` | 0 | 0 | 10 | 0 |
| `alisveris_puani` | 2 | 2 | 10 | 1 |
| `kampanya_suresi` | 52 | 51 | 6 | 0 |
| `kampanya_kosullari` | 9 | 6 | 5 | 4 |
| `hedef_kitle` | 4 | 2 | 8 | 0 |
...
| `kuveyt-turk--kampanya-arsivi-hepsiburada-alisveris-finansmaninda-enerji-tasarrufu-haftasina-o` | `kampanya_kosullari` |
...
| `ziraat-katilim--kart-kampanyalari-size-ozel-banka-karti-kampanyasi` | `hedef_kitle` |
| `ziraat-katilim--kart-kampanyalari-size-ozel-banka-karti-kampanyasi` | `kampanya_kosullari` |
| `ziraat-katilim--kart-kampanyalari-troy-kartla-drda-1000-tlye-varan-indirim` | `kampanya_kosullari` |
| `ziraat-katilim--kart-kampanyalari-troy-kartla-drda-1000-tlye-varan-indirim` | `odul_miktari` |
...
| `kuveyt-turk--kart-kampanyalari-saglam-business-karttan-dev-kampanya-3-ay-erteleme-ve-349-oran` | `kampanya_kosullari` |
| `kuveyt-turk--katilma-hesaplari-ara-donem-kar-payi-odemeli-hesaplar` | `vade_ay` |
| `kuveyt-turk--katilma-hesaplari-birikimli-katilma-hesabi` | `kampanya_kosullari` |
