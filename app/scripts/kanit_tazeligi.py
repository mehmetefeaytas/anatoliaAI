    ...
    return [
        Iddia(
            ...
            desenler=(
                ...
                ("README.md", r"([\d.]+) geçti"),
                ("app/docs/sunum/anatolia-ai-sunum.html", r"<em>([\d.]+)</em> yeşil test"),
            ),
        ...
        Iddia(
            ...
            desenler=(
                ...
                ("app/docs/sunum/anatolia-ai-sunum.html", r'sayac"[^>]*>([\d,]+)</span>\s*<p>12 alanda mikro-F1'),
            ),
        ...
        Iddia(
            ...
            desenler=(
                ...
                ("app/docs/sunum/anatolia-ai-sunum.html", r'sayac"[^>]*>(0,\d+)</span>\s*<p>halüsinasyon'),
            ),
        ...
        Iddia(
            ...
            desenler=(
                ...
                ("app/docs/sunum/anatolia-ai-sunum.html",
                 r'sayac"[^>]*>([\d,]+)</span>\s*<p>yapısal alan mikro-F1'),
            ),
        ...
        Iddia(
            ...
            desenler=(
                ...
                ("app/docs/sunum/anatolia-ai-sunum.html",
                 r'sayac"[^>]*>([\d,]+)</span>\s*<p>altın setin κ'),
            ),
