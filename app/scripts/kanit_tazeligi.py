    ...
    return [
        ...
        Iddia(
            ...
            desenler=(
                ...
                ("app/docs/sunum/anatolia-ai-sunum.html", r'sayac"[^>]*>([\d,]+)</span><p>12 alanda mikro-F1'),
            ),
        ...
        Iddia(
            ...
            desenler=(
                ...
                ("app/docs/sunum/anatolia-ai-sunum.html", r'sayac"[^>]*>(0,\d+)</span><p>halüsinasyon'),
            ),
        ...
        Iddia(
            ...
            desenler=(
                ...
                ("app/docs/sunum/anatolia-ai-sunum.html",
                 r'sayac"[^>]*>([\d,]+)</span><p>yapısal alan mikro-F1'),
            ),
        ...
        Iddia(
            ...
            desenler=(
                ...
                ("app/docs/sunum/anatolia-ai-sunum.html",
                 r'sayac"[^>]*>([\d,]+)</span><p>altın setin κ'),
            ),
