...
| seed | 42 |
| git sha | c4bdb3d8d097fc6b8f4da8a4a7d92a9b45a3c7a5 |
...
| üretim zamanı (UTC) | 2026-08-12T14:31:01.558142+00:00 |
...
|---|---|---|---|---|---|---|
| TÜMÜ | 0.403 | 0.446 | 0.424 | 0.471 | 0.424 [0.364–0.477] | 0.074 |
| ZOR (40 belge) | 0.431 | 0.455 | 0.442 | 0.478 | — | 0.074 |
...
| format_varyant | 0.458 | 0.467 | 41 | 49 | 48 |
...
| alt küme | P (mikro) | R (mikro) | F1 (mikro) | F1 (makro) | mikro-F1 %95 GA | halüsinasyon |
|---|---|---|---|---|---|---|
| TÜMÜ | 0.411 | 0.455 | 0.432 | 0.507 | 0.432 [0.374–0.484] | 0.074 |
| ZOR (40 belge) | 0.440 | 0.464 | 0.451 | 0.515 | — | 0.074 |
