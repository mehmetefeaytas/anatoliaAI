...
| gold sha256 | dc0e45d8ec27901b… |
| gold kayıt sayısı | 134 |
| alt küme (split) | all |
| eşleştirici(ler) | strict, tolerant |
| seed | 42 |
| git sha | 552098a075ede1b1744228acee6b8a658d17549f |
...
| üretim zamanı (UTC) | 2026-08-21T11:22:17.678398+00:00 |
...
|---|---|---|---|---|---|---|
| TÜMÜ | 0.733 | 0.743 | 0.738 | 0.600 | 0.738 [0.673–0.803] | 0.344 |
| ZOR (3 belge) | 0.400 | 0.500 | 0.444 | 0.667 | — | 1.000 |
| YAPILANDIRILMIŞ (11 alan) | 0.768 | 0.768 | 0.768 | 0.651 | — | 0.322 |
...
| finansman_tutari | 0.800 | 0.364 | 0.500 | 8 | 2 | 14 | 5 | 0 | 104 |
...
Tüm alanlarda mikro-F1: ikili **0.738** · kalem **0.728**.
...
|---|---|---|---|---|
| 0.60 | 0.728 | 119 | 53 | 36 |
| 0.70 ← ilan edilen | 0.728 | 119 | 53 | 36 |
| 0.80 | 0.728 | 119 | 53 | 36 |
