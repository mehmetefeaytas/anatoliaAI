...
| üretim zamanı (UTC) | 2026-08-07T15:30:25.212019+00:00 |
...
|---|---|---|---|---|---|---|
| TÜMÜ | 0.353 | 0.429 | 0.387 | 0.408 | 0.387 [0.329–0.442] | 0.101 |
...
| alt küme | P (mikro) | R (mikro) | F1 (mikro) | F1 (makro) | mikro-F1 %95 GA | halüsinasyon |
|---|---|---|---|---|---|---|
| TÜMÜ | 0.360 | 0.438 | 0.395 | 0.445 | 0.395 [0.336–0.449] | 0.101 |
