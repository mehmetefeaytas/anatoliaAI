...
| gold sha256 | 1c6202fbdb6c88d8… |
| gold kayıt sayısı | 48 |
| alt küme (split) | all |
| eşleştirici(ler) | strict |
| seed | 42 |
| git sha | 6e7f3f43385efcfe2b963e699dafe8f1fa97b3f4 |
...
| üretim zamanı (UTC) | 2026-08-07T12:34:54.137835+00:00 |
...
|---|---|---|---|---|---|---|
| TÜMÜ | 0.353 | 0.429 | 0.387 | 0.408 | — | 0.101 |
...
| vade_ay | 0.091 | 0.200 | 0.125 | 1 | 10 | 4 | 36 | 6 | 0 |
