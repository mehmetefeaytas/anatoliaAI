...
| seed | 42 |
| git sha | 43e0f506bd12dd69f7ef36b7bf631c9243c1dd63 |
...
| üretim zamanı (UTC) | 2026-08-08T18:12:15.841456+00:00 |
...
|---|---|---|---|---|---|---|
| TÜMÜ | 0.356 | 0.429 | 0.389 | 0.409 | 0.389 [0.335–0.443] | 0.099 |
...
| alt küme | P (mikro) | R (mikro) | F1 (mikro) | F1 (makro) | mikro-F1 %95 GA | halüsinasyon |
|---|---|---|---|---|---|---|
| TÜMÜ | 0.363 | 0.438 | 0.397 | 0.446 | 0.397 [0.340–0.450] | 0.099 |
