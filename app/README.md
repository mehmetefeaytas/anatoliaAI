...
[![Testler](https://img.shields.io/badge/testler-2943%20ye%C5%9Fil-brightgreen.svg)](tests/)
...
**Test:** **2.996** birim/entegrasyon testi toplanıyor, tamamı offline yeşil
...
| Testler | ✅ **2.943 test yeşil** (2.996 toplanan · 0 başarısız), ağ gerektirmeden koşuyor (bağımlılıksız koşuda 53'i atlanır — API yüzeyi `test-with-deps` işinde sınanır) |
