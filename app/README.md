...
[![Testler](https://img.shields.io/badge/testler-3150%20ye%C5%9Fil-brightgreen.svg)](tests/)
...
**Test:** **3.203** birim/entegrasyon testi toplanıyor · **3.150 geçiyor** ·
...
> |---|---:|---:|---:|---:|
> | `unittest` (kanonik — `scripts.test_ozeti`) | **3.203** | **3.150** | 53 | **0** |
> | `pytest` (`pytest tests/ -q`) | **3.203** | **3.150** | 53 | **0** (+1.307 subtest) |
>
...
> yapılan ölçümde fark **tekrarlanmıyor** — iki koşucu da 3.203 topluyor.
...
| tam test paketi | **3.150 geçti · 0 başarısız** — hiçbir şey kırılmadı |
